...
[Configure.Auth.cs](https://github.com/NetCoreTemplates/blazor/blob/main/Stackers/Configure.Auth.cs):
...
[CustomUserSession.cs](https://github.com/NetCoreTemplates/blazor/blob/main/Stackers.ServiceInterface/Data/CustomUserSession.cs), e.g:
...
for a new Blazor Project from its [Program.cs](https://github.com/NetCoreTemplates/blazor/blob/main/Stackers/Program.cs):
...
services.AddDbContext<ApplicationDbContext>(options =>
    options.UseSqlite(connectionString, b => b.MigrationsAssembly(nameof(Stackers))));
...
configuration in its [Program.cs](https://github.com/NetCoreTemplates/mvc/blob/main/Stackers/Program.cs) which will 
also require adding the NuGet dependencies of the OAuth providers you want to support which you can get from its
[Stackers.csproj](https://github.com/NetCoreTemplates/mvc/blob/main/Stackers/Stackers.csproj)
...
UI Pages are in the 
[Components/Identity](https://github.com/NetCoreTemplates/blazor/tree/main/Stackers/Components/Identity) and 
[Pages/Account](https://github.com/NetCoreTemplates/blazor/tree/main/Stackers/Components/Pages/Account) folders.

For MVC, most of the Identity UI are in the 
[Account](https://github.com/NetCoreTemplates/mvc/blob/main/Stackers/Controllers/AccountController.cs)
and [Manage](https://github.com/NetCoreTemplates/mvc/blob/main/Stackers/Controllers/ManageController.cs) controllers
as well as their
[Views/Account](https://github.com/NetCoreTemplates/mvc/tree/main/Stackers/Views/Account) and
[Views/Manage](https://github.com/NetCoreTemplates/mvc/tree/main/Stackers/Views/Manage) folders.
...
[Configure.Mq.cs](https://github.com/NetCoreTemplates/blazor/blob/main/Stackers/Configure.Mq.cs)
which uses it to invoke the `SendEmail` API in 
[EmailServices](https://github.com/NetCoreTemplates/blazor/blob/main/Stackers.ServiceInterface/EmailServices.cs) in a 
