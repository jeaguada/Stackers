...
const project = ref('Stackers')
const projectZip = computed(() => (project.value || 'Stackers') + '.zip')

/** @param {string} template */
const zipUrl = (template:string) =>
    `https://account.servicestack.net/archive/${template}?Name=${project.value || 'Stackers'}`
